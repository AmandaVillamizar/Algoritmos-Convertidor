...
Partial Class FormPrestar
    ...
    Private Sub InitializeComponent()
        ...
        lblAutor.BackColor = Color.Gainsboro
        lblAutor.ForeColor = SystemColors.ActiveCaptionText
        ...
        ' btnPrestar
        ' 
        btnPrestar.ForeColor = SystemColors.ActiveCaptionText
        btnPrestar.Location = New Point(300, 300)
        ...
        ' txtAutor
        ' 
        txtAutor.BackColor = Color.LightGray
