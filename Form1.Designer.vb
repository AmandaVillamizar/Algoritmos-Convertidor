...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        ' btnPrestar
        ' 
        btnPrestar.BackColor = Color.Gainsboro
        btnPrestar.ForeColor = Color.Black
        ...
        ' btnDevolver
        ' 
        btnDevolver.BackColor = Color.Gainsboro
        btnDevolver.ForeColor = Color.Black
        btnDevolver.Location = New Point(481, 187)
